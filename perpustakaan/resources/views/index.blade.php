...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-black bg-black">
            ...
            <a class="navbar-brand ps-4" href="/"> <img src="{{asset('admin/assets/img/LogoPerpus.jpg')}}" width="130px" > </a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-info bg-black" id="sidenavAccordion">
